...
if(Sys.info()["user"] == "linde069"){
  Rijn <- readOGR(dsn = "D:/Analyses/HedonicSpatialWQ/SurveyData", layer = "newRijn")
}
...
library(Deducer)
sink('Results/Analysis-output_Rijnmond.txt')
...
lm_Rijn_2000_4NN <- lm.LMtests(Rijn2000_OLS_E, knn4_W, zero.policy=TRUE, test="all")
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm_Rijn_2000_10NN <- lm.LMtests(Rijn2000_OLS_E, knn10_W, zero.policy=TRUE, test="all")
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm_Rijn_2005_4NN <- lm.LMtests(Rijn2005_OLS_E, knn4_W2005, zero.policy=TRUE, test="all")
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm_Rijn_2005_10NN <- lm.LMtests(Rijn2005_OLS_E, knn10_W2005, zero.policy=TRUE, test="all")
...
sink('Results/Analysis-output_Rijnmond.txt', append=TRUE)
cat("=========================================================================\n")
