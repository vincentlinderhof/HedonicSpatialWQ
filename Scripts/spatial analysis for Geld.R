...
sink('Results/Analysis-output_Geldplassen.txt', append=TRUE)
cat("=========================================================================\n")
...
lm <- lm.LMtests(Geld2000_OLS_E, knn4_W, zero.policy=TRUE, test="all")
lm2000_4NN <-lm
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm10 <- lm.LMtests(Geld2000_OLS_E, knn10_W, zero.policy=TRUE, test="all")
lm2000_10NN <-lm10
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm2005 <- lm.LMtests(Geld2005_OLS_E, knn4_W2005, zero.policy=TRUE, test="all")
lm2005_4NN <-lm2005
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm200510n <- lm.LMtests(Geld2005_OLS_E, knn10_W2005, zero.policy=TRUE, test="all")
...
rm(Geld2004, Geld2005_OLS_b, Geld2005_OLS_c, Geld2005_OLS_d)
rm(Geld25nerror, Geld25nlag, Gelderror, Gelderror2, Geldlag, Geldlag2)
rm(GeldSubset, GeldSubSet, GeldSubsetln)
rm(OLSGeld, OLSGeld_A, OLSGeld1, OLSGeld10)
rm(OLSGeld1996, OLSGeld2, OLSGeld2000, OLSGeld2004)
rm(OLSGeld3, OLSGeld4, OLSGeld5, OLSGeld6)
rm(OLSGeld7, OLSGeld8, OLSGeld9, OLSGeld_B, OLSGeld_C, OLSGeld_D, OLSGeld_E)
rm(SPEGeld_E, SPLGeld_E, queen1)
rm(Geld10nerror, Geld10nerror2, Geld10nlag, Geld10nlag2)
rm(subset)
