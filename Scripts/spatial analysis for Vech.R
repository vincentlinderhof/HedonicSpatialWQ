...
lm <- lm.LMtests(Vech2000_OLS_E, knn4_W, zero.policy=TRUE, test="all")
lm2000_4NN <-lm
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm10 <- lm.LMtests(Vech2000_OLS_E, knn10_W, zero.policy=TRUE, test="all")
lm2000_10NN <-lm10
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm2005 <- lm.LMtests(Vech2005_OLS_E, knn4_W2005, zero.policy=TRUE, test="all")
lm2005_4NN <-lm2005
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm200510n <- lm.LMtests(Vech2005_OLS_E, knn10_W2005, zero.policy=TRUE, test="all")
...
rm(Vech2004, Vech2005_OLS_b, Vech2005_OLS_c, Vech2005_OLS_d)
rm(Vech25nerror, Vech25nlag, Vecherror, Vecherror2, Vechlag, Vechlag2)
rm(VechSubset, VechSubSet, VechSubsetln)
rm(OLSVech, OLSVech_A, OLSVech1, OLSVech10)
rm(OLSVech1996, OLSVech2, OLSVech2000, OLSVech2004)
rm(OLSVech3, OLSVech4, OLSVech5, OLSVech6)
rm(OLSVech7, OLSVech8, OLSVech9, OLSVech_B, OLSVech_C, OLSVech_D, OLSVech_E)
rm(SPEVech_E, SPLVech_E, queen1)
rm(Vech10nerror, Vech10nerror2, Vech10nlag, Vech10nlag2)
rm(subset)
