...
# Reading the data from a shapefile (all data for Flevplassen)
...
############################## START OF MODULE ###########################################################
## Descriptive statistics for Flevplassen
...
sink('Results/Analysis-output_Flevplassen.txt', append=TRUE)
cat("=========================================================================\n")
...
lm <- lm.LMtests(Flev2000_OLS_E, knn4_W, zero.policy=TRUE, test="all")
lm2000_4NN <-lm
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm10 <- lm.LMtests(Flev2000_OLS_E, knn10_W, zero.policy=TRUE, test="all")
lm2000_10NN <-lm10
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm2005 <- lm.LMtests(Flev2005_OLS_E, knn4_W2005, zero.policy=TRUE, test="all")
lm2005_4NN <-lm2005
...
# test OLS models with weighing matrix and run spatial error and spatial lag model for model E
lm200510n <- lm.LMtests(Flev2005_OLS_E, knn10_W2005, zero.policy=TRUE, test="all")
...
rm(Flev2004, Flev2005_OLS_b, Flev2005_OLS_c, Flev2005_OLS_d)
rm(Flev25nerror, Flev25nlag, Fleverror, Fleverror2, Flevlag, Flevlag2)
rm(FlevSubset, FlevSubSet, FlevSubsetln)
rm(OLSFlev, OLSFlev_A, OLSFlev1, OLSFlev10)
rm(OLSFlev1996, OLSFlev2, OLSFlev2000, OLSFlev2004)
rm(OLSFlev3, OLSFlev4, OLSFlev5, OLSFlev6)
rm(OLSFlev7, OLSFlev8, OLSFlev9, OLSFlev_B, OLSFlev_C, OLSFlev_D, OLSFlev_E)
rm(SPEFlev_E, SPLFlev_E, queen1)
rm(Flev10nerror, Flev10nerror2, Flev10nlag, Flev10nlag2)
rm(subset)
